...
MODEL_NOTES = {
    "model.status": "V2.3模型渲染视角；2D、3D与十一张渲染图共用同一套墙线、房间、开口和家具坐标",
...
def build_home_xml() -> str:
    lines: list[str] = [
        ...
        f"<home {attrs(version='7500', name='荟雅苑104.83㎡_三房两卫_模型渲染视角V2.3.sh3d', camera='topCamera', wallHeight=WALL_HEIGHT, basePlanLocked='true')}>",
    ]
    ...
    lines.extend([
        ...
        "  <camera attribute='topCamera' lens='PINHOLE' x='420' y='-175' z='2600' yaw='0' pitch='1.24' fieldOfView='1.0471976' time='1787731200000'/>",
        "  <observerCamera attribute='observerCamera' lens='PINHOLE' x='330' y='1120' z='160' yaw='3.559' pitch='0.08' fieldOfView='1.2217305' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='客厅电视墙视角' lens='PINHOLE' x='330' y='1120' z='160' yaw='3.559' pitch='0.08' fieldOfView='1.2217305' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='客厅窗景视角' lens='PINHOLE' x='620' y='1070' z='160' yaw='2.25' pitch='0.08' fieldOfView='1.2217305' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='餐厅回望视角' lens='PINHOLE' x='450' y='1360' z='170' yaw='2.665' pitch='0.12' fieldOfView='1.3089969' time='1787731200000'/>",
        "  <camera attribute='storedCamera' name='全屋俯视视角' lens='PINHOLE' x='420' y='-175' z='2600' yaw='0' pitch='1.24' fieldOfView='1.0471976' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='主卧俯视视角' lens='PINHOLE' x='500' y='165' z='240' yaw='0' pitch='1.50' fieldOfView='2.10' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='次卧俯视视角' lens='PINHOLE' x='160' y='165' z='240' yaw='0' pitch='1.50' fieldOfView='2.10' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='书房客卧俯视视角' lens='PINHOLE' x='138' y='475' z='240' yaw='0' pitch='1.50' fieldOfView='2.10' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='厨房俯视视角' lens='PINHOLE' x='685' y='1260' z='240' yaw='0' pitch='1.50' fieldOfView='2.10' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='主卫俯视视角' lens='PINHOLE' x='548' y='410' z='240' yaw='0' pitch='1.50' fieldOfView='2.00' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='客卫俯视视角' lens='PINHOLE' x='548' y='560' z='240' yaw='0' pitch='1.50' fieldOfView='2.00' time='1787731200000'/>",
        "  <observerCamera attribute='storedCamera' name='家政阳台俯视视角' lens='PINHOLE' x='758' y='1040' z='240' yaw='0' pitch='1.50' fieldOfView='1.90' time='1787731200000'/>",
    ...
    lines.extend([
        ...
        label("note_accuracy", "V2.3设计校核：十一张预设渲染视角；客厅西窗前600净空；2D/3D同源", 315, 1460, "FFB45D2A"),
    ])
    lines.append("</home>")
    return "\n".join(lines) + "\n"
