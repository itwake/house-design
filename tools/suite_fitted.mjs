...
export function applyFittedSuite(d){
  ...
  d.version='3.2.2 · suite fitted';d.geometryRevision='suite-fitted-2026-09-22';
...
export function updateFittedCatalog(catalog,d){
  catalog.version='3.2.2';const s=catalog.schemes.find(v=>v.id==='suite');
  Object.assign(s,{name:'木光 · 暖白套间',tagline:'凹位做满，光线更柔和',summary:d.layout.intent,style:'暖白浅木 · 套间入口',assetRevision:'3.2.2',appearance:d.appearance,
