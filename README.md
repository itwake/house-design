# 荟雅苑 104.83㎡ · 三房两卫完整概念设计

基于 Sweet Home 3D JS Viewer 的静态网页。V1.1 在比例户型和逐空间设计的基础上，修正了次卧 B 门洞位置，并为室内门加入独立门框、把手和浅橡木纹理：

- 可旋转、缩放和漫游的 `.sh3d` 三维设计模型；
- 客餐厅、玄关、厨房、主卧、次卧、书房、双卫和生活阳台共九个空间的效果参考与设计说明；
- 141 个参数化家具、柜体、洁具与设备构件，以及 14 组设计灯光；
...
- 主卧按 1500 mm 床与整墙衣柜组织；次卧兼顾儿童、长辈或客房；书房采用 1600 mm 双人长桌与日床；
- 双卫分别强调主卫舒适性和公卫高频使用，均设置干湿分离；
- 生活阳台集中洗烘、家政高柜与晾晒系统。
