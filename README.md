...
当前第二方案为 **V3.2.3 / 暖白套间**：在已确认的家具布局和暖白配色上，补回厨房与家政阳台共墙大窗。暂按洞宽1200、高1300、窗台1000mm建模；尺寸、窗型及墙体条件待现场复核。保留两边台下柜及原有门，厨房层板缩至窗边实墙范围。平面、GLB、Blender及16张同源效果图同步；原wood对照资产不变。详见[大窗修正与验证](docs/kitchen-balcony-window-v323.md)。
