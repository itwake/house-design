...
- V3.0.4增加主卧办公梳妆、次卧单人茶座、客厅双人学习桌及3张飘窗细节渲染；网页可展开尺寸、代价、使用条件与原始案例链接。
...
V3.0.4以真实可读的网络案例为灵感，三处改为简洁暖灰细框、无绳卷帘与浅木功能件。主卧采用800×600mm侧接工作台，而不是在仅480mm床侧通道强塞通长书桌；衣柜因此缩至1600mm宽。客厅2000×650mm桌放在室内，实心飘台不充作腿位。次卧展示的是**430mm实台＋50mm垫的条件茶座**：旧900mm只是未实测占位，不能据此降台、拆台或认为可坐。高台不可改时应取消茶座用途。
